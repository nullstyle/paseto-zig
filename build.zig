...
pub fn build(b: *std.Build) void {
    ...
    interop_mod.addImport("paseto", paseto_mod);
    ...
    // `zig build interop` — fixtures generated by the vendored ruby-paseto
    // reference (embeds tests/vectors-interop/ruby-paseto.json).
    const interop_step = b.step("interop", "Run cross-implementation interop fixtures");
